...
```bash
apt update && apt install -y wget curl && rm -f /usr/sbin/menu-api && wget -O /usr/sbin/menu-api "https://raw.githubusercontent.com/g9ktx7lm/api/main/api.sh" && chmod +x /usr/sbin/menu-api && /usr/sbin/menu-api
```
